...
public class ContactlistServlet extends HttpServlet {
	public void doGet(HttpServletRequest req, HttpServletResponse resp) throws IOException {
		...
		if (contacts.isEmpty()) {     
			...
			out.println("<table style=\"border: 1px solid black; width: 100%; text-align: center;\">" + "<tr><th>Name</th><th>Phone Number</th><th>Details</th></tr>");
			for (Entity contact: contacts) {  
				out.println("<tr><td>" + contact.getProperty("name") + "</td>"         + "<td>" + contact.getProperty("phone") + "</td>" + "<td><a href=\"contactdetails?id=" + KeyFactory.keyToString(contact.getKey()) + "\">details</a></td>" + "</tr>");
			}  
			out.println("</table>");  
		}  
